...
Este capítulo tem o objetivo de descrever de forma sucinta a historia das linguagens de programação e os principais tópicos envolvidos na realização deste trabalho. 
...
Durante estos anos surgiu o termo de Programação estruturada, que visava restringir o uso de desvios incondicionais (GoTo).
...
Com a chegada da internet, sugiram as linguagens de scripting que não são evolução direta de nenhuma linguagem já estabelecida anteriormente, senão que foram concebidas com novas sintaxes e novas funções.
